...
import iphoneImage from "../../dist/images/iphone-mockup.png";
        ...
        <div className="container">
          <div className="hero-inner">
            <div className="hero-copy">
              <h1 className="hero-title mt-0">HandsFreeBrowse</h1>
              <p className="hero-paragraph">
              <b>HandsFreeBrowse</b> is an AI-based program created to help you navigate your computer with <b>no physical touch at all!</b> 
              </p>
